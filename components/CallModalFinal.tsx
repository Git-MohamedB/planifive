            ...
            {isOpen && (
                ...
                >
                    ...
                    >
                        ...
                        {/* Body */}
                        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: '0 100px' }}>
                            {success ? (
                                ...
                                <form onSubmit={handleSubmit} className="flex flex-col h-full">
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '50px', paddingTop: '40px' }}>
                                        {/* Date */}
                                        <div>
                                        ...
                                        <div className="flex gap-20">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <div className="flex bg-[#2A2A2A] rounded-full p-1 h-[38px] shadow-lg">
                                                    <button
                                                        type="button"
                                    ...
                                    {/* Actions */}
                                    <div style={{ display: 'flex', justifyContent: 'center', gap: '64px', marginTop: 'auto', paddingBottom: '10px' }}>
                                        <button
                                            type="button"
                                            onClick={onClose}
