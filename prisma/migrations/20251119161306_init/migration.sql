...
-- CreateIndex
CREATE INDEX "Availability_date_hour_idx" ON "Availability"("date", "hour");

-- CreateIndex
CREATE UNIQUE INDEX "AvailabilityTemplate_userId_dayOfWeek_hour_key" ON "AvailabilityTemplate"("userId", "dayOfWeek", "hour");
